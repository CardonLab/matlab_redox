function out = adjustRefBase(tblRedox,startDate,endDate, vars)
...
% This function will subtract the mean of the extra probes from the redox probes
    ...
    mask = startsWith(tblRedox.Properties.VariableNames, "Ref_0");
    ...
    out = varfun(@(x) x - tblRedox.refMean,tblRedox,"InputVariables",vars);
